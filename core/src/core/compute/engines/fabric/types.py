"""Fabric-specific type definitions for Spark engine implementation.

This module contains types that are specific to the Microsoft Fabric Spark
...
class SessionStatus(str, Enum):
    """Status of a Fabric Spark session."""
    STARTING = "starting"
    IDLE = "idle"
    BUSY = "busy"
...
class SparkSessionConfig(BaseModel):
    """Configuration for Fabric Spark session.
...
class JobDefinition(BaseModel):
    """Definition of a Fabric Spark job."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True
    )
...
class SessionInfo(BaseModel):
    """Information about a Fabric Spark session."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True
    )
...
class StatementResult(BaseModel):
    """Result of a Fabric Spark statement execution."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True
    )
...
class JobDefinitionInfo(BaseModel):
    """Information about a Fabric job definition."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True
    )
...
class FileUploadResult(BaseModel):
    """Result of file upload for Fabric Spark job."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True
    )
...
class JobLogs(BaseModel):
    """Logs from a Fabric Spark job execution."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True
    )
...
class NotebookConfig(BaseModel):
    """Configuration for Fabric notebook execution.
...
class NotebookResult(BaseModel):
    """Result of Fabric notebook execution."""
    model_config = ConfigDict(
        arbitrary_types_allowed=True,
...
# Export all Fabric-specific types
__all__ = [
    'SessionStatus',
    'SparkSessionConfig',
    'JobDefinition',
